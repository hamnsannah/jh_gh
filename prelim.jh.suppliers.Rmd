...
# Sales Over Time for All Suppliers

```{r, allin, echo = FALSE, warning=FALSE, message=FALSE, fig.height=4}
...
#  scale_fill_brewer(palette = "RdBu") + theme_dark()+ 
...
## Chart of Monthly Sales for `r top.sup1` - #1 Supplier for Selected Time
...
## Chart of Monthly Sales for `r top.sup2` - #2 Supplier for Selected Time
...
autoplot(sup2.ts) + theme_dark() + geom_line(color = "#a3bfed", size = 4)

exploratory.top.three.prod.ts(top.sup2, data.clean)
```

## Chart of Monthly Sales for `r top.sup3` - #3 Supplier for Selected Time
...
autoplot(sup3.ts) + theme_dark() + geom_line(color = "#a3bfed", size = 4)
