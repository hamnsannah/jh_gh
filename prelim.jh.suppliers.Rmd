...
#next if-else
if(file.exists(paste0("data/anon.sales", Sys.Date(), ".csv"))){ #change back to "data/sales.data.cache" in this line and next
  data.clean <- read.csv(paste0("data/anon.sales", Sys.Date(), ".csv"), stringsAsFactor = FALSE)
} else {
